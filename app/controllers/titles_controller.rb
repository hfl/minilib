class TitlesController < ApplicationController
  ...
  before_action :get_resource, only:[:new, :create]
  ...
  # POST /titles.json
  def create
    @title = @resource.titles.new(title_params)

    respond_to do |format|
      if @title.save
        format.html { redirect_to @resource, notice: 'Title was successfully created.' }
